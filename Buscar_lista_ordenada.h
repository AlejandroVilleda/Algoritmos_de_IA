...
/* Halla la solución por el algoritmo de amplitud */
    ...
    vector<Nodo *> Nodos_visitados;
    vector<Nodo *> Nodos_frontera;
    vector<int> Hijo;
    Nodo *nodo;

    auto *NodoInicial = new Nodo(Estado_inicial);
    Nodos_frontera.push_back(NodoInicial);

    while((!Solucionado) && (!Nodos_frontera.empty()))
    {
        nodo = Nodos_frontera.back();
        Nodos_frontera.pop_back();
        ...
        else
        {
            ...
            {
                Nodos_frontera.push_back(HijoIzquierdo);
            }
            ...
            {
                Nodos_frontera.push_back(HijoCentral);
            }
            ...
            {
                Nodos_frontera.push_back(HijoDerecho);
            }
